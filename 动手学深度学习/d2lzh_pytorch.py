...
def data_iter(batch_size, features, labels):
    ...
    for i in range(0, num_examples, batch_size):
        ...
        # yield的函数：返回一个可迭代的
        # generator（生成器）对象，你可以使用for循环或者调用next()
        # 方法遍历生成器对象来提取结果
...
def load_data_jay_lyrics(Max_size=10000):
    ...
    corpus_chars = corpus_chars[0:Max_size]
